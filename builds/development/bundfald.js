...
$(document).ready(function() {
            ...
            $(".btn_pos").click(function() {
                ...
                if (opgavetype == 1) {
                    if (pos_selected != opg_pos) {
                        ...
                        UserMsgBox(".inner_container", "Korrekt! <br/>Vælg nu den negative ion.");
                        ...
                        if (opgavetype == 0) {
                            ...
                            if (neg_selected != opg_neg) {
                                ...
                                var resultat_interaktion = "<div class='select_wrapper_reaktion'><form id='reak_form' class='bund_select bund_select_radio'>" +
                                    ...
                                    "<div class='radio_cont'><input type='radio' class='radio_btn' name='reaktion' value='0'><div class='radio_text 0_rdio'>" + svar_Array[opg_pos][opg_neg][2] + "</div></div><br/>";
        ...
        function poseQuestion() {
            ...
            if (underopgave == "c_1") {
                $("h4").html("Dan Ionforbindelsen der indeholder <b>" + positive_ioner[opg_pos] + "</b> og <b>" + negative_ioner[opg_neg] + "</b>, afstem reaktionen og vælg det rigtige resultat");
                ...
                $("h4").html("Dan Ionforbindelsen <b>" + reaktions_Array[opg_pos][opg_neg][2] + "</b>, afstem reaktionen og vælg det rigtige resultat");
            }
        }
